...
make -j$(nproc --all) O=out       ARCH=arm64       LD=ld.lld       NM=llvm-nm       AR=llvm-ar       CC="ccache clang"       CLANG_TRIPLE=aarch64-linux-gnu-      CROSS_COMPILE=aarch64-linux-gnu-       CROSS_COMPILE_ARM32=arm-linux-gnueabi-
V=0 2>&1 | tee log.txt
